                  ...
                  >
                    ...
                    <td className="py-2.5 px-3">
                      ...
                      <div className="text-[11px] text-slate-500 dark:text-slate-400">
                        {caso.especie} · {caso.raca || 'SRD'} {caso.idade ? `· ${caso.idade}` : ''}
                      </div>
                    </td>
                    ...
                    {/* Clínica */}
                    <td className="py-2.5 px-3">
                      <div className="text-slate-800 dark:text-slate-200 truncate max-w-[180px]" title={caso.veterinarioClinica}>
                    ...
                    <td className="py-2.5 px-3 whitespace-nowrap text-[11px]">
                      ...
                      {caso.laboratorio && (
                        <span className="text-slate-400 ml-1">/ {caso.laboratorio}</span>
                      )}
                    </td>
                    ...
                    <td className="py-2.5 px-3 text-right whitespace-nowrap">
                      <button
                        ...
                        className="inline-flex items-center gap-1 text-xs font-semibold text-emerald-700 dark:text-emerald-400 group-hover:text-emerald-900 group-hover:translate-x-0.5 transition-all cursor-pointer"
                      >
